...
<header>
    ...
    <div class="container-fluid">
        ...
        <h1 >Azure OCR Tester Test 1.0</h1>

        <!-- <h2>The small framework with powerful features</h2> -->
        <div class="row justify-content-center">
            <div class="col-6">
                <form action="#" id="form" method="post" onsubmit="return perform_ocr(event)">
                    <div class="row">
                        <label >Image URL</label>
                        <input id="imageUrl" class="form-control" type="text"/>
                    ...
                    <div id="drag-and-drop-zone" class="dm-uploader p-5">
                        ...
                        <div class="btn btn-primary btn-block mb-5">
                            ...
                            <input type="file" title='Click to add Files' accept=".jpg,.jpeg,.png,.pdf,.tiff"/>
                        </div>
                    </div>
                    ...
                    <button class="btn btn-primary btn-lg d-block mb-2" id="add_post_btn" type="submit">Run OCR</button>
